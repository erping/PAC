...
<%
	...
	if(Bchao==""){
		dao.Bchao = "0";
	}else dao.Bchao = Bchao;
	String canliu = request.getParameter("canliu");
	if(canliu==""){
		dao.canliu = "0";
	}else dao.canliu = canliu;
	String neimo = request.getParameter("neimo");
	if(neimo==""){
		dao.neimo = "0";
	}else dao.neimo = neimo;
	...
	String yuejinghuifu = request.getParameter("yuejinghuifu");
	if(yuejinghuifu==""){
		dao.yuejinghuifu = "0";
	}else dao.yuejinghuifu = yuejinghuifu;
	String huifushijian = request.getParameter("huifushijian");
	if(huifushijian==""){
		dao.huifushijian = "0";
	}else dao.huifushijian = huifushijian;
	String yuejingxueliang = request.getParameter("yuejingxueliang");
	if(yuejingxueliang==""){
		dao.yuejingxueliang = "0";
	}else dao.yuejingxueliang = yuejingxueliang;
...
function jump(){
	...
	if(method=="patient")
		...
		url = "daisuifang_n.jsp?shuming=<%=person%>";
...
<center>
       ...
       <a href="daisuifang_n.jsp?shuming=<%=person%>&method=suifang">[点击继续]</a>
   </center>
</body>
</html>