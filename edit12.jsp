...
function do_zhongyuan12(){
	...
	if(adviseform.name.value!="" && adviseform.num.value!=""){
		...
		url="do_zhongyuan12.jsp?name="+name+"&date="+date+"&shijian="+shijian+"&num="+num
...
<form action="javascript:void(0)" name="adviseform" id="Form1" method="post" accept-charset="utf-8">
  <table class="b-content">
    <tr  id="r_table">
    	...
    	<%
    	String num,name,tel,nibiyun,biyun,COCshijian,COCchufang,IUDfangzhi,gaowei="";
      ...
      <td>
        <input type="radio" disabled="disabled" name="shijian" value="3">
       	...
       	<input type="radio" disabled="disabled" name="shijian" value="6">
       		6
       	<input type="radio" disabled="disabled" name="shijian" value="12" checked="checked">
       		12
       </td>
    </tr>
    <%
    ...
    <tr  id="r_table" class="disrenshen" style="display:none">
	 ...
	 <tr  id="r_table">
       ...
       <td align="right"><input type="button" name="first" value="保存" onClick = "do_zhongyuan12()"/>
       </td>
    </tr>
  </table>
 </form>
