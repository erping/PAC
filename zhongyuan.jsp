...
function do_zhongyuan(){
	...
	var COCzhonglei = adviseform.COCzhonglei.value;
	...
	var riqi = adviseform.riqi.value;
	var riqi2 ="";
	if(adviseform.riqi2!=undefined){
		riqi2= adviseform.riqi2.value;
	}
	...
	var huanjie ="";
	if(adviseform.huanjie!=undefined){
		huanjie= adviseform.huanjie.value;
	}
	...
	if(adviseform.name.value!="" && adviseform.num.value!=""){
		...
		url="do_zhongyuan.jsp?name="+name+"&date="+date+"&num="+num+"&tel="+tel
				+"&fangshi="+fangshi+"&chuxuetianshu="+chuxuetianshu+"&youwubingfa="+youwubingfa+"&bingfa="+bingfa
				+"&qitabingfa="+qitabingfa+"&chuxue="+chuxue
				...
				+"&qitaCOCyuanyin="+qitaCOCyuanyin+"&COCjixuchufang="+COCjixuchufang+"&COCchufangshu="+COCchufangshu+"&IUDfangzhi="+IUDfangzhi
				+"&IUDjianchi="+IUDjianchi+"&IUDfangzhi2="+IUDfangzhi2+"&riqi="+riqi+"&riqi2="+riqi2+"&IUDyuanyin="+IUDyuanyin+"&qitaIUDyuanyin="+qitaIUDyuanyin
				...
				+"&qitafeigaoxiao="+qitafeigaoxiao+"&yiwai="+yiwai+"&huanjie="+huanjie+"&renshen="+renshen+"&zhongzhi="+zhongzhi+"&person="+person+"&method="+method;
...
function do_back(method){
	...
	if(method=="patient")
		...
		url = "daisuifang_n3.jsp?shuming=<%=request.getParameter("shuming")%>";
	window.location.href = url;
}
</script>
...
<form action="javascript:void(0)" name="adviseform" id="Form1" method="post" accept-charset="utf-8">
  <table class="b-content">
    <tr  id="r_table">
			<td  colspan="2">
    			<img width="725" height="45" src="Images/sangeyuesuifang.jpg"/>
			</td>
		</tr>
    	<tr  id="r_table">
    ...
    <tr  id="r_table" class="disCOCjixu" style="display:none">
      <td class="r_cell_1"><div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;*本次补充落实周期数</div></td>
      <td>
    ...
    <tr  id="r_table" class="disIUDfangzhi3" style="display:none">
      ...
      <td class="star">
      	<div><input name="riqi2" type="text" size="30" id="datepicker-example16" >
      	</div>
      </td>
    </tr>
	...
	<tr  id="r_table">
	 ...
	 <tr  id="r_table">
       ...
       <td align="right">
       <input type="image" id="save1" src="Images/save.jpg" onClick="do_zhongyuan()"/>
	   </td>
    </tr>
  </table>
 </form>
